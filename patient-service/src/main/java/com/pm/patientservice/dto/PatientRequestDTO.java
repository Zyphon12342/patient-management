...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Data of birth is required") String getDateOfBirth() {
        return dateOfBirth;
    }

    public void setDateOfBirth(@NotBlank(message = "Data of birth is required") String dateOfBirth) {
